...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tempExit = new HashMap<>();
        tempExit.put("W", 1);
        locations.put(3, new Location(3, "You are inside the building, a well house for a small spring", tempExit));
        ...
        while (true) {
            ...
            System.out.println("You can also type with words in which direction you want to go!");
